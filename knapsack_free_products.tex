...
A similar statement can be made about $\SSP$ with the help of Propsition~\ref{pr:agp_to_ssp_cross}. %as will be clear from the proof of Proposition~\ref{pr:ssp_cross} below.
...
\end{figure}
\end{proof}
%{\li{This statement implies a natural question: what about Karp reduction?}} {\an Not convinced this is interesting, unless I am missing something.}
