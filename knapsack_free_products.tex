...
\begin{figure}[h]
 ...
 \caption{Reduction of $\BSMP(G)$ to $\SSP(G\times \mathbb Z)$}. \label{fi:bsmp_to_ssp}
\end{figure}
\end{proof}
...
\begin{corollary}
$\SSP$ is $\NP$-complete in braid groups $B_n$, $n\ge 8$, special linear groups $SL(n,\mathbb Z)$, $n\ge 5$, graph groups whose graph contains an induced square pyramid.
\end{corollary}
\begin{proof}
