...
{\li{I'm sorry, but I can't understand how it does not distort the size.}}
...
\end{corollary}
{\li{I know we use it only with $F_2$, but are you sure you don't wan't to change it to arbitrary f.g. free group?}}
...
{\li{But we will answer another one, right?}} {\an I don't understand the question. Another one what?}{\li{We say, it's good to ask about $\SSP(F_2\times F_2)$, and then immediately change the subject.}}
